...
// we will use the mocktail library. We will mock the underlying api client in order to unit test the WeatherRepository logic in an isolated, controlled environment.